        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoPageTitle = table.Column<string>(type: "nvarchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentId = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    IconCss = table.Column<string>(type: "varchar(MAX)", nullable: true),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Resource = table.Column<string>(type: "nvarchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "text", nullable: true),
                    GroupAlias = table.Column<string>(type: "nvarchar(25)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    Value1 = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    ...
                    Value5 = table.Column<decimal>(type: "decimal", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FunctionId = table.Column<string>(type: "nvarchar(255)", nullable: false),
